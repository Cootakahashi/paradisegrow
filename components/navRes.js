...
export function NavRes(){
    return (
        <>
        <div className="hidden navres flex overflow-hidden bg-white rounded-lg h-screen">
            <div className="hidde md:flex md:flex-shrink-0">
                <div className="flex flex-col w-64">
                    <div className="flex flex-col flex-grow pt-5 overflow-y-auto border-r bg-neutral-800">
                        <div className="flex flex-col items-center flex-shrink-0 px-4">
                            ...
                            <button className="hidde rounded-lg focus:outline-none focus:shadow-outline">
                        ...
                        <div className="flex flex-col flex-grow px-4 mt-5">
                            <nav className="flex-1 space-y-1 bg-neutral-800">
                                <ul>
                                    <li>
                                        <a className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-neutral-200 bg-neutral-900 border-neutral-900 focus:shadow-outline" white="" href="#">
                                ...
                                <ul>
                                    <li>
                                        <a className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-neutral-200 border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" white="" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex flex-shrink-0 p-4 px-4 bg-neutral-900">
                            <a href="#" className="flex-shrink-0 block w-full group">
                                <div className="flex items-center">
                                    <div>
                                        <Image className="inline-block rounded-full h-9 w-9" src="/logo/fortitle/2.png" 
                                        width={200}
                                        height={200}
                                        alt="logo"/>
                                    </div>
                                    <div className="ml-3">
                                        <p className="text-sm font-medium text-neutral-200">Paradise grows</p>
                                    </div>
                                </div>
                            </a>
                        </div>
