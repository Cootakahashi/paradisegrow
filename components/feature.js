...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="text-center mb-20 overflow-hidden">
      <h1 className="sm:text-3xl translate-y-40 title-anime text-3xl font-medium title-font text-gray-900 mb-4 font-serif whitespace-nowrap">Science of Cannabis</h1>
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      ...
      <div className="p-4 md:w-1/3 flex flex-col text-center items-center md:translate-y-32">
        <div className="w-72 h-72 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
        <Image
            className="object-cover w-full h-full rounded  sm:h-full ml-20 mt-2"
            src="/canva/relax.png"
